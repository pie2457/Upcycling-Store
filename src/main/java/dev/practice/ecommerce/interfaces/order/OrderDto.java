...
public class OrderDto {
	...
	public static class RegisterOrderRequest {
		...
		@NotBlank(message = "etcMessage 는 필수값 입니다.")
	...
	public static class PaymentRequest {
		@NotBlank(message = "orderToken 는 필수값 입니다.")
		private String orderToken;

		@NotNull(message = "payMethod 는 필수값 입니다.")
		private PayMethod payMethod;

		@NotNull(message = "amount 는 필수값 입니다.")
		private Long amount;

		@NotBlank(message = "orderDescription 는 필수값 입니다.")
